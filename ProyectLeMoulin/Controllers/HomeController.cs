        ...
        public ActionResult Index()
        {
            ...
            for (int i = 0; i < photos.Count; i++)
            {
                t += "<div data-img='../tinyfilemanager.net/resources/files/" + photos[i].photos +
                    "' data-thumb='../tinyfilemanager.net/resources/thumbs/" + photos[i].photos + "' ><div><div class='cubobajatexto'></div> <a class='fotorama__select' href='/Home/Evenement?id=" + photos[i].titre + "'>" +
